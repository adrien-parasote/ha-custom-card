...
.corner-border-top-alert:before, .corner-border-top-alert:after, .corner-border-bottom-alert:before, .corner-border-bottom-alert:after {
    border-style: solid;
    border-width: 0;
...
.corner-border-top::before, .corner-border-top-alert::before {
    border-left-width: var(--card-border-width);
    border-top-width: var(--card-border-width);
    left: 0;
    top: -1px;
}
.corner-border-top::after, .corner-border-top-alert::after {
    border-right-width: var(--card-border-width);
    border-top-width: var(--card-border-width);
    right: 0;
    top: -1px;
}
.corner-border-bottom::before, .corner-border-bottom-alert::before {
    border-bottom-width: var(--card-border-width);
    border-left-width: var(--card-border-width);
    bottom: -1px;
    left: 0;
}
.corner-border-bottom::after, .corner-border-bottom-alert::after {
    border-bottom-width: var(--card-border-width);
    border-right-width: var(--card-border-width);
    bottom: -1px;
    right: 0;
