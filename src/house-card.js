...
export class HouseCard extends LitElement {
  static styles = [
    ...
    css`
      ...
      .first-floor:hover, .ground:hover{
        cursor: pointer;
        .lighting path {
          ...
          >
            ...
            <g class="first-floor" transform="matrix(1, 0, 0, 1, 162, 31)">
              ...
              <g>
                ...
                <path class="background-no-stroke" d="M 0 125 L 340 125 L 340 245 L 0 245 Z"/>
              </g>
            </g>
            <g class="ground">
              ...
              <g transform="matrix(1, 0, 0, 1, 162, 151)">
                <path style="fill:transparent;" d="M 0 125 L 0 245 L 340 245 L 340 125"/>
              </g>
            </g>
